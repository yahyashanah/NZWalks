    ...
    public partial class SeedingDataForDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("7a0f8472-01d7-46b8-a8e2-8518b8c2795b"), "Hard" },
                    { new Guid("840d2f4f-572c-4444-a229-6fb74342bd01"), "Medium" },
                    { new Guid("87fcccd8-ca98-4bf6-a940-9a877c760a1e"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("7a0f8472-01d7-46b8-a8e2-8518b8c2795b"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("840d2f4f-572c-4444-a229-6fb74342bd01"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("87fcccd8-ca98-4bf6-a940-9a877c760a1e"));
